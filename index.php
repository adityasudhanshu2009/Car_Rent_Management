       ...
       <div class="container h-100">
            <div class="row h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end mb-4 page-title">
                  <h3 class="text-white-heading" >Welcome to <?php echo $_SESSION['system']['name']; ?></h3>
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"> © 2022 - MADE BY | <a href="https://github.com/ayushD123" target="_blank">AYUSH DIXIT & </a><a href="https://github.com/adityasudhanshu2009" target="_blank"> ADITYA SUDHANSHU</a></div></div>
        </footer>
